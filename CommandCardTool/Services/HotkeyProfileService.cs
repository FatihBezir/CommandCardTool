...
internal static class HotkeyProfileService
{
    ...
    /// <summary>PURCHASE_SCIENCE star slots use SCIENCE: keys; Leikeze stores hotkeys on CONTROLBAR: build labels.</summary>
    ...
    /// <summary>Finds profile label text for a command-card slot (label + optional image CSF id).</summary>
    ...
    /// <summary>Variant build label → tooltip CSF in Leikeze / game CSF.</summary>
